                ...
                <div className="bg-white block py-10">
                    <div className="max-w-2xl mx-auto">
                        ...
                        <div className="bg-primary border border-primary rounded-b-lg p-5 pt-20 flex flex-col">
                            <div className="mb-1 bg-gray-200 border border-gray-300 h-5 w-40 text-gray-900 pb-6 pl-2">
                                fede beron
                            </div>
                            ...
                            <div className="text-sm mt-2 text-gray-200">
                                <div className="flex flex-row ml-auto space-x-2 items-center">
                                    <div className="mb-1 bg-gray-200 border border-gray-300 h-5 w-20 text-gray-900 pb-4 pl-2 text-gray-300">351</div>
                                    <div className="bg-blue-200 rounded-full h-1 w-1"></div>
                                    <div className="mb-1 bg-gray-200 border border-gray-300 h-5 w-40 text-gray-900 pb-4 pl-2 text-gray-300">5421576</div>
                                </div>
                            </div>

                            <div className="py-5 break-all bbcode">
                                <div className="mb-1 bg-gray-200 border border-gray-300 h-5 w-44 pb-6 pl-2">CUIT</div>
