...
const Admin = () => {
    return (
            ...
            <div className="flex flex-wrap w-96 container mx-auto">
                <Link href="/bills">
                    <div className="pl-1 my-2 w-96 h-20 bg-green-400 rounded-lg shadow-md cursor-pointer">
                ...
                <Link href="/stock">
                    <div className="pl-1 my-2 w-96 h-20 bg-blue-500 rounded-lg shadow-md cursor-pointer">
                        <div className="flex w-full h-full py-2 px-4 bg-white rounded-lg justify-between">
                            <div className="my-auto">
                ...
                <Link href="/products">
                    <div className="pl-1 my-2 w-96 h-20 bg-yellow-400 rounded-lg shadow-md cursor-pointer">
                        <div className="flex w-full h-full py-2 px-4 bg-white rounded-lg justify-between">
                            <div className="my-auto">
