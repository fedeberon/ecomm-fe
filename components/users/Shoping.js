            ...
            <PageTitle text="Mis Compras">
                <div className="relative w-full sm:max-w-md lg:max-w-xl">
                    ...
                    <input
                        ...
                        className="h-11 w-full rounded-xl border border-gray-200 bg-gray-50 py-2.5 pl-10 pr-10 text-sm text-gray-800 outline-none transition focus:border-palette-sdark focus:bg-white focus:ring-2 focus:ring-palette-sdark/10"
                        aria-label="Buscar compras"
                    />
                    {search && <button type="button" onClick={clearSearch} className="absolute inset-y-0 right-0 flex items-center px-3 text-gray-400 hover:text-gray-700" aria-label="Limpiar búsqueda">×</button>}
                </div>
            </PageTitle>
