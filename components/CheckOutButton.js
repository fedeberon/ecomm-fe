          ...
          <div className={"flex"}>
            <a onClick={() => handleBilling('A')}
             ...
             className="bg-gray-500 text-white text-lg font-primary font-semibold pt-2 pb-1 leading-relaxed flex cursor-pointer
              justify-center items-center focus:ring-1 focus:ring-palette-light focus:outline-none w-1/2 hover:bg-gray-700 rounded-md mr-4">
              Factura A
            </a>
            ...
            <a onClick={() => handleBilling('B')}
                  ...
                  justify-center items-center focus:ring-1 focus:ring-palette-light focus:outline-none w-1/2 hover:bg-yellow-700 rounded-md ml-4">
              Factura B
            </a>
          </div>
